...
public class JavammParser extends Parser {
	...
	public static class PrecedentContext extends ExpressionContext {
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public PrecedentContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JavammListener ) ((JavammListener)listener).enterPrecedent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JavammListener ) ((JavammListener)listener).exitPrecedent(this);
		}
	}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case T__2:
				{
				_localctx = new PrecedentContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
