...
public interface JavammListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code Precedent}
	 * labeled alternative in {@link JavammParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterPrecedent(JavammParser.PrecedentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Precedent}
	 * labeled alternative in {@link JavammParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitPrecedent(JavammParser.PrecedentContext ctx);
	/**
